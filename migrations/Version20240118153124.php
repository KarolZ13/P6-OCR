 ...
 */
final class Version20240118153124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD CONSTRAINT FK_D8F0A91EA21214B7 FOREIGN KEY (categories_id) REFERENCES category (id)');
